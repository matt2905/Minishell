...
/*   Updated: 2013/12/25 20:44:05 by mmartin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_check_specbis(va_list ap, const char *str, t_printf *fl, int *i)
{
	char	*tmp;
...
void		ft_check_spec(va_list ap, const char *str, t_printf *fl, int *i)
{
	if (*str == 's')
...
void			ft_redirect(va_list ap, const char *str, int *i)
{
	t_printf	flags;
	int			p;
